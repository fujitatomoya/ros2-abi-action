# lyrical-source.Dockerfile
#
# Source-built ROS 2 Lyrical underlay for ABI checks of core repositories
# (ros-abi:lyrical-source). See humble-source.Dockerfile for the full design
# notes; this file follows the official "Ubuntu (source)" page for Lyrical:
#
...
#   Tier 1 platform  : Ubuntu Resolute (26.04)
#   rosdep skip keys : fastcdr rti-connext-dds-7.7.0 urdfdom_headers
#
...
WORKDIR /opt/ros2_ws
RUN mkdir -p src \
    && curl -fsSL https://raw.githubusercontent.com/ros2/ros2/lyrical/ros2.repos -o ros2.repos \
...
ENV ROS_ABI_UNDERLAY=/opt/ros2_ws/install/setup.bash \
    ...
    ROS_ABI_REPOS_URL=https://raw.githubusercontent.com/ros2/ros2/lyrical/ros2.repos \
    ROS_ABI_ROSDEP_SKIP_KEYS="fastcdr rti-connext-dds-7.7.0 urdfdom_headers"
