# kilted-source.Dockerfile
#
# Source-built ROS 2 Kilted underlay for ABI checks of core repositories
# (ros-abi:kilted-source). See humble-source.Dockerfile for the full design
# notes; this file follows the official "Ubuntu (source)" page for Kilted:
#
...
#   rosdep skip keys : fastcdr rti-connext-dds-7.3.0 urdfdom_headers
#
...
WORKDIR /opt/ros2_ws
RUN mkdir -p src \
    && curl -fsSL https://raw.githubusercontent.com/ros2/ros2/kilted/ros2.repos -o ros2.repos \
...
RUN apt-get update \
    ...
    && rosdep install --from-paths src --ignore-src -y \
         --skip-keys "fastcdr rti-connext-dds-7.3.0 urdfdom_headers" \
    && rm -rf /var/lib/apt/lists/*
...
ENV ROS_ABI_UNDERLAY=/opt/ros2_ws/install/setup.bash \
    ...
    ROS_ABI_REPOS_URL=https://raw.githubusercontent.com/ros2/ros2/kilted/ros2.repos \
    ROS_ABI_ROSDEP_SKIP_KEYS="fastcdr rti-connext-dds-7.3.0 urdfdom_headers"
