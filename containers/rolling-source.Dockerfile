# rolling-source.Dockerfile
#
# Source-built ROS 2 Rolling underlay for ABI checks of core repositories
# (ros-abi:rolling-source). See humble-source.Dockerfile for the full design
# notes; this file follows the official "Ubuntu (source)" page for Rolling:
#
...
ENV ROS_ABI_UNDERLAY=/opt/ros2_ws/install/setup.bash \
    ...
    ROS_ABI_REPOS_URL=https://raw.githubusercontent.com/ros2/ros2/rolling/ros2.repos \
